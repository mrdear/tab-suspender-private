/**
 * Tab Suspender - Statistics Dashboard JavaScript
 */
...
// ========== SHARE YOUR IMPACT ==========
const PROJECT_URL = 'https://github.com/theluckystrike/zovo-tab-suspender-public';
...
function getShareText() {
    ...
    return `🚀 I've saved ${memory} of memory by suspending ${tabs} tabs with Tab Suspender. My browser is lighter now. ${PROJECT_URL}`;
}
...
function shareOnFacebook() {
    const url = `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(PROJECT_URL)}&quote=${encodeURIComponent(getShareText())}`;
    window.open(url, '_blank', 'width=550,height=420');
}
